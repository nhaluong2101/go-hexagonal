...
func (m *MockUserRepository) GetUserByID(ctx context.Context, id uint64) (*models.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) ListUsers(ctx context.Context, skip, limit uint64) ([]models.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserService) GetUser(ctx context.Context, id uint64) (*models.User, error) {
	m.ctrl.T.Helper()
...
// ListUsers mocks base method.
func (m *MockUserService) ListUsers(ctx context.Context, skip, limit uint64) ([]models.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListUsers", ctx, skip, limit)
	ret0, _ := ret[0].([]models.User)
	ret1, _ := ret[1].(error)
